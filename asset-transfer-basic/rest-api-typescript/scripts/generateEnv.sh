...
: "${PRIVATE_KEY_FILE_ORG1:=${TEST_NETWORK_HOME}/organizations/peerOrganizations/org1.example.com/users/User1@org1.example.com/msp/keystore/a6129b6d7bf8647503667bbe95866597b8f4f41dc6db537e62e8302b935d717f_sk}"
...
: "${PRIVATE_KEY_FILE_ORG2:=${TEST_NETWORK_HOME}/organizations/peerOrganizations/org2.example.com/users/User1@org2.example.com/msp/keystore/0fd648522c2eec52afd5ccc5556bb19480cea55aef71284681505edae05e6a8c_sk}"
